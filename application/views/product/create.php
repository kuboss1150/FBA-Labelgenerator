		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        ...
                        <input type="text" name="jan" id="jan" class="form-control" value="<?= set_value('jan'); ?>" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                        <input type="text" name="asin" id="asin" class="form-control" value="<?= set_value('asin'); ?>" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                        <input type="text" name="sku" id="sku" class="form-control" value="<?= set_value('sku'); ?>" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                        <input type="text" name="fnsku" id="fnsku" class="form-control" value="<?= set_value('fnsku'); ?>" />
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                        <input type="text" name="name_en" id="name_en" class="form-control" value="<?= set_value('name_en'); ?>" />
					</div>
				</div>
			</div>
		</div>
