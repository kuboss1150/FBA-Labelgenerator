...
<?php echo form_open(current_url(), ['class'=>'form-horizontal']); ?>
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="text-info"><?= lang('create_domain'); ?></h3>
		</div>
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                        <input type="text" name="domain" id="domain" class="form-control" value="<?= set_value('domain'); ?>" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        ...
                        <input type="text" name="login_url" id="login_url" class="form-control" value="<?= set_value('login_url'); ?>" />
					</div>
				</div>
			</div>
			<!-- <div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        ...
                        <input type="text" name="user_field" id="user_field" class="form-control" value="<?= set_value('user_field'); ?>" />
					</div>
				</div>
			</div> -->
			<!-- <div class="form-group">
				...
				<div class="col-md-6 col-xs-12">
					<div class="input-group">
                        ...
                        <input type="text" name="password_field" id="password_field" class="form-control" value="<?= set_value('password_field'); ?>" />
					</div>
				</div>
			</div> -->
		</div>
